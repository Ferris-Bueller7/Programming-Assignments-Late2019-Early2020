/**
  *   This is a Java class tests the Directory class with a variety of different calls. 
    I modified the class sent by the instrucctor slightly because I felt the if/else
    block didn't work properly.
